...
export default function useRegisterComponentValidation(groupName, validate) {
  const { registerComponentValidator, unregisterComponentValidator } = useContext(FormInputContext);
  ...
  }, [groupName, registerComponentValidator, unregisterComponentValidator, validate]);
}
