...
import { isStringInteger } from '../../../util/helpers';
...
const DateInput = ({
  ...
  const isValidDate = () => {
    ...
    switch (restriction) {
      case 'past':
        return date.isBefore() ? true : 'Bitte geben Sie ein Datum in der Vergangenheit an.';
      case 'todayAndFuture':
    ...
    <>
      ...
      <div className="flex flex-col">
        <div className="flex flex-row">
          <div className="w-16 flex-shrink-0 mr-2 md:mr-1" style={{ maxWidth: '5rem' }}>
            <Input
          ...
          <div className="flex-grow">
            <Input
              ...
              onValidate={(v) => {
                if (typeof v !== 'string' || isEmpty(v) || !(Number(v) > 1900)) {
        ...
        <ValidationError fieldName={['birthday-day', 'birthday-month', 'birthday-year']} />
      </div>
    </>
  );
};
