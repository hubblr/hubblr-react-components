...
export function isHouseNumber(v) {
  ...
  return new RegExp(`^${singleHouseNumberStr}(?:-${singleHouseNumberStr})?$`).test(v);
}
...
export const IsScreenMD = typeof window !== 'undefined' && window.innerWidth > MobileBreakpoint - 1;

export const IsScreenLG = typeof window !== 'undefined' && window.innerWidth > TabletBreakpoint - 1;

export const isScreenXL =
  typeof window !== 'undefined' && window.innerWidth > SmallDesktopBreakpoint - 1;

/* eslint-disable react/jsx-filename-extension,react/jsx-props-no-spreading */
export const DesktopQuery = (props) => <Responsive {...props} minWidth={TabletBreakpoint} />;

export const MobileQuery = (props) => <Responsive {...props} maxWidth={MobileBreakpoint - 1} />;

export const MobileAndTabletQuery = (props) => (
  <Responsive {...props} maxWidth={TabletBreakpoint - 1} />
);

export const TabletQuery = (props) => <Responsive {...props} minWidth={MobileBreakpoint} />;

export const TabletOnlyQuery = (props) => (
  <Responsive {...props} minWidth={MobileBreakpoint} maxWidth={TabletBreakpoint - 1} />
);
